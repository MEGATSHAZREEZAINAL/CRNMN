...
export const MOCK_INITIAL_INVENTORY: InventoryItem[] = [
  { id: 'corn', name: 'Jagung Biji', stock: 15, threshold: 20 }, // Low stock example
  { id: 'milk', name: 'Susu Pekat', stock: 50, threshold: 25 },
  { id: 'butter', name: 'Mentega', stock: 45, threshold: 25 },
  { id: 'cheese', name: 'Serbuk Keju', stock: 30, threshold: 20 },
  { id: 'cup', name: 'Cawan (Besar)', stock: 250, threshold: 100 },
  { id: 'cup-small', name: 'Cawan (Kecil)', stock: 80, threshold: 100 }, // Low stock example
];
