...
const colorMap: Record<NonNullable<StatusCardProps['color']>, { card: 'default' | 'glass' | 'elevated' | 'brand' | 'ghost'; badge: 'ghost' | 'brand' | 'success' | 'warning' | 'error' | 'info'; progress: 'brand' | 'success' | 'warning' | 'error' | 'ghost'; text: string; }> = {
  brand: {
    card: 'brand',
    badge: 'brand',
    progress: 'brand',
